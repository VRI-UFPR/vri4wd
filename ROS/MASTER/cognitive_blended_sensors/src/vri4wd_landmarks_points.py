...
pub_landmarks = rospy.Publisher('/landmark_vri4wd_points', Point, queue_size=10)
...
while not rospy.is_shutdown():
	...
	if teclado == 'w':
		...
		# Read the CSV file
		dataframe = pd.read_csv("/home/magrin/catkin_ws/src/cognitive_blended_sensors/dataset/topographicPointsUFPR.csv")
		...
		rospy.loginfo("North: %f East: %f Altitude: %f ", north, east, altitude)
